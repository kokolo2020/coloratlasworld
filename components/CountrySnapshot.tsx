...
export default function CountrySnapshot({ data, initialOpen = false }: { data: CountrySnapshotData; initialOpen?: boolean }) {
  ...
  const historicPhotoUrl = "https://tile.loc.gov/storage-services/service/pnp/cph/3b30000/3b34000/3b34100/3b34163r.jpg";
  return (
      ...
      <section className="snapshot-dialog usa-poster-shell" role="dialog" aria-modal="true" aria-labelledby="snapshot-title">
        ...
        <div className="usa-poster">
          ...
          <footer className="poster-bottom">
            <article className="poster-about"><img className="poster-about-photo" src={historicPhotoUrl} alt="Statue of Liberty, circa 1901" /><div><strong>About the United States</strong><p>{summary}</p></div></article>
